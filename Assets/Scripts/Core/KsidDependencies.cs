    ...
    class KsidDependencies : Ksids
    {
        public KsidDependencies()
            : base(new (Ksid child, Ksid parent)[]
            {
                ...
                (Ksid.DirtBuilder, Ksid.InventoryItem),
                (Ksid.JoinerGlue, Ksid.InventoryItem),
                (Ksid.DeepGlue, Ksid.InventoryItem),
                (Ksid.StickyBomb, Ksid.Explosive),
                (Ksid.DirtBuilder, Ksid.Explosive),
                ...
                (Ksid.JoinerGlue, Ksid.ActivatesByThrow),
                (Ksid.DeepGlue, Ksid.ActivatesByThrow),
                (Ksid.JoinerGlue, Ksid.DisconnectedByCatch),
                (Ksid.StickyBomb, Ksid.DisconnectedByCatch),
                (Ksid.Stone, Ksid.SandLike),
                (Ksid.Light, Ksid.SandLike),
                (Ksid.Knife, Ksid.SandLike),
                (Ksid.JoinerGlue, Ksid.SandLike),
                (Ksid.DeepGlue, Ksid.SandLike),
